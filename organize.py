...
# Organize by extracting the file types from the file name
def org():
        ...
        if os.path.isfile(os.path.join(folder_to_track, file)):
            ...
            for types in generalize:
                if os.path.splitext(file)[1].lower() in generalize[types]:
                    ...
                    print(file, dest) # Console log the file moved
                    move_file(src, dest, file)

# Move the file and create the sub-directory if it doesn't exist
